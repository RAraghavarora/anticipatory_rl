...
OUT_ROOT="${OUT_ROOT:-runs/talukder_scale_full}"
SEED_FROM="${SEED_FROM:-0}"
SEED_TO="${SEED_TO:-4}"
ANT_WEIGHTS="${ANT_WEIGHTS:-runs/talukder_full_ant_seed0/restaurant_dqn.pt}"
MYO_WEIGHTS="${MYO_WEIGHTS:-runs/talukder_full_myo_seed0/restaurant_dqn.pt}"
