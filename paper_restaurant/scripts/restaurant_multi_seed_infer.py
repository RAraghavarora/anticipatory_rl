...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--pick-cost", type=float, default=25.0)
    p.add_argument("--place-cost", type=float, default=25.0)
    p.add_argument("--wash-cost", type=float, default=25.0)
    p.add_argument("--fill-cost", type=float, default=25.0)
    p.add_argument("--brew-cost", type=float, default=25.0)
    p.add_argument("--fruit-cost", type=float, default=25.0)
