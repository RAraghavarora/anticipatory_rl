...
def _object_to_pddl(name: str) -> str:
    """Names are already synchronized with the PDDL objects."""
    return name


def _receptacle_to_pddl(name: str) -> str:
    """Names are already synchronized with the PDDL receptacles."""
    return name
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--domain", default="pddl/gridworld_domain.pddl", help="Path to the domain PDDL file.")
    parser.add_argument(
        "--problem-template",
        default="pddl/gridworld_problem.pddl",
